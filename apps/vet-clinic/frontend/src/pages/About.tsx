      ...
      <section>
        ...
        <div className="prose prose-primary max-w-none">
          <p className="text-lg text-gray-700 leading-relaxed">
            A production-ready Online Appointment Booking (OAB) platform designed for Canadian
            healthcare and service providers. This veterinary variant is built with
            <strong> PIPEDA compliance</strong> for pet owner data protection, featuring
            multi-pet management, breed database integration, and species-specific appointment types.
          </p>
          <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
            <p className="text-sm text-green-800">
              <strong>Demo Notice:</strong> This is a demonstration system with synthetic/fictional data only.
              No real pet owner or animal information is stored or processed.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            <h3 className="font-semibold text-gray-900 mb-2">Pet Owner Self-Service</h3>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>Book, reschedule, and cancel appointments online</li>
              <li>Manage multiple pets under one account</li>
              <li>Breed typeahead with 400+ breeds</li>
              <li>Species-specific appointment types</li>
            </ul>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-5">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              <li>Veterinarian schedule management</li>
              <li>Booking approval workflows</li>
              <li>Statistical reporting</li>
              <li>PIPEDA-compliant audit trail</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="flex items-start gap-6">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              ...
              meet the unique regulatory requirements of Canadian healthcare and veterinary services.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <a
              ...
              className="block bg-white rounded-lg border-2 border-blue-200 p-5 hover:border-blue-400 hover:shadow-md transition-all"
            >
              ...
              <p className="text-xs text-blue-600 mt-2">{window.location.hostname}:3001</p>
            </a>
            ...
            >
              ...
              <p className="text-xs text-primary-600 mt-2">{window.location.hostname}:3002</p>
            </a>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-1 ml-4 list-disc">
                  <li>"Book a checkup for Max next Tuesday"</li>
                  <li>"When is Bella's next vaccination due?"</li>
                  <li>"Reschedule my cat's appointment to next week"</li>
                  <li>"Find an available exotic vet for my parrot"</li>
                </ul>
                <p className="text-xs text-purple-600 mt-3">
                  Making pet care booking as easy as having a conversation
                </p>
              </div>
            </div>
          </div>
